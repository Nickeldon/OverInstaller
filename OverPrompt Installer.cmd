...
echo starting to install Git for Windows 64-bit

powershell -Command "(New-Object System.Net.WebClient).DownloadFile('https://github.com/git-for-windows/git/releases/download/v2.42.0.windows.2/Git-2.42.0.2-64-bit.exe', 'Git-2.42.0-64-bit.exe'); Start-Process -Wait -FilePath .\Git-2.42.0-64-bit.exe"

pause

echo starting to install OverPrompt on this client
